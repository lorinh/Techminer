function love.conf(t)
	t.identity = '.Techminer'                   -- The name of the save directory (string)
	t.version = "0.9.1"                -- The LVE version this game was made for (string)
	t.console = false                 -- Attach a console (boolean, Windows only)

	t.window.title = "Techminer"        -- The window title (string)
	t.window.icon = "/Images/TownHall.png"-- Filepath to an image to use as the window's icon (string)
